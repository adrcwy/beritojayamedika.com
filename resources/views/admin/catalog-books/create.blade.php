<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-extrabold text-gray-800">Upload Catalog Book</h2>
    ...
    <div class="bg-gradient-to-br from-gray-50 via-blue-50/20 to-gray-50 py-10">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('catalog-books.store') }}" method="POST" enctype="multipart/form-data" class="rounded-3xl border border-gray-100 bg-white p-6 shadow-xl sm:p-8">
                @csrf
                @include('admin.catalog-books.form', ['catalogBook' => null])
            </form>
        </div>
    </div>
</x-app-layout>
